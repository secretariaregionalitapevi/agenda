...
const CACHE_VERSION = "ccbagenda-v13";
const ASSETS = ["/", "/manifest.webmanifest", "/styles/install-prompt.css", "/scripts/install-prompt.js", "/icons/icon-192.png", "/icons/icon-512.png"];
